...
const menus = [{cn: '首页', path: '/'}, {cn: 'Java培训', path: '/java-primary'}, {cn: 'React培训', path: '/react-primary'}, {
    cn: '教学服务', path: '/service'
}, {
    cn: '就业保障', path: '/3'
}, {
    cn: '技术交流', path: '/4'
    ...
    render() {
        ...
        return <div className="top-header">
            <div className="inner">
                ...
                {!trainee.id && <div className='btn' onClick={() => App.go('/login')}>登入</div>}
                {trainee.id && <div className='btn' onClick={() => App.go('/trainee/profile')}>学员中心</div>}
